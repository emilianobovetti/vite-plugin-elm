...
//@ts-ignore
const node_elm_compiler_1 = __importDefault(require("node-elm-compiler")); // @ts-ignore
//@ts-ignore
    ...
    return {
        ...
        async transform(_code, id) {
            ...
            try {
                ...
                const esm = (0, elm_esm_1.toESModule)(compiled);
                const hotFixForMissingKey = 'function() { key.a(onUrlChange(_Browser_getUrl())); };';
                const replaced = !isBuild && esm.includes('elm$browser$Browser$application')
